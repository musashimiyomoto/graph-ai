...
Revision ID: b608d77ba6c0
Revises:
Create Date: 2026-02-11 09:49:27.730461
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "finished_at", sa.DateTime(), nullable=True, comment="Execution end time"
        ),
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False, comment="ID"),
